...
const UUID = process.env.UUID || 'fb1619ef-79fa-4792-b57f-47662f8aad39';
...
const YALI_DOMAIN = process.env.YALI_DOMAIN || 'pipeops.merucmn.eu.org';              
const YALI_AUTH = process.env.YALI_AUTH || 'eyJhIjoiOTlhY2VhZTUyZGNkMGExYzQyZDNkNjkwMGZhODc5YjYiLCJ0IjoiODFhYWQ2ZTYtZWQ5Ny00OTY3LWFiMjEtZWJjZWRhODYzNDRiIiwicyI6Ik1ERmpPR0kwWkRJdFlXTmtOaTAwTW1Ga0xXRTNZMlF0WWpJd1pUVmlPV0kyWm1SaSJ9';                 
